...
VALUES (
        'Herbaceas',
        'Plantas para jardin decorativas',
        NULL,
        NULL
    );
...
VALUES (
        'Frutales',
        'Árboles pequeños de producción frutal',
        NULL,
        NULL
    );
...
VALUES (
        'Ornamentales',
        'Plantas vistosas para la decoración del jardín',
        NULL,
        NULL
    );
...
VALUES (
        ...
        '916877445',
        '914477777',
        'Polígono Industrial Maspalomas, Nº52',
        'Móstoles',
        'Madrid',
        'Madrid',
        'Spain',
...
VALUES (
        ...
        '2008-11-14',
        'Entregado',
        'El cliente paga la mitad con tarjeta y la otra mitad con efectivo, se le realizan dos facturas',
        1
    );
...
VALUES (
        ...
        '2008-12-28',
        'Entregado',
        'El cliente comprueba la integridad del paquete, todo correcto',
        1
    );
...
VALUES (
        ...
        NULL,
        'Pendiente',
        'El cliente llama para confirmar la fecha - Esperando al proveedor',
        3
    );
...
VALUES (
        ...
        NULL,
        'Pendiente',
        'El cliente requiere que el pedido se le entregue de 16:00h a 22:00h',
        1
    );
...
VALUES (
        ...
        NULL,
        'Pendiente',
        'El cliente requiere que el pedido se le entregue de 9:00h a 13:00h',
        1
    );
...
VALUES (
        ...
        NULL,
        'Rechazado',
        'El pedido fue anulado por el cliente',
        5
    );
...
VALUES (
        ...
        NULL,
        'Rechazado',
        'El cliente carece de saldo en la cuenta asociada',
        1
    );
...
VALUES (
        ...
        NULL,
        'Rechazado',
        'El cliente anula la operacion para adquirir mas producto',
        3
    );
...
VALUES (
        ...
        NULL,
        'Entregado',
        'El pedido aparece como entregado pero no sabemos en que fecha',
        3
    );
...
VALUES (
        ...
        '2009-02-20',
        'Entregado',
        'El cliente se queja bastante de la espera asociada al producto',
        3
    );
...
VALUES (
        ...
        '2008-09-01',
        'Rechazado',
        'El cliente no está conforme con el pedido',
        14
    );
...
VALUES (
        ...
        '2008-10-04',
        'Rechazado',
        'El cliente ha rechazado por llegar 5 dias tarde',
        13
    );
...
VALUES (
        ...
        '2007-01-27',
        'Entregado',
        'Entrega tardia, el cliente puso reclamacion',
        4
    );
...
VALUES (
        ...
        NULL,
        'Pendiente',
        'El pedido nunca llego a su destino',
        4
    );
...
VALUES (
        ...
        '2008-03-29',
        'Entregado',
        'Según el Cliente, el pedido llegó defectuoso',
        26
    );
...
VALUES (
        ...
        '2008-07-30',
        'Entregado',
        'El pedido llegó 1 día tarde, pero no hubo queja por parte de la empresa compradora',
        26
    );
...
VALUES (
        ...
        NULL,
        'Pendiente',
        'Al parecer, el pedido se ha extraviado a la altura de Sotalbo (Ávila)',
        26
    );
...
VALUES (
        ...
        '2008-10-14',
        'Entregado',
        'Todo se entregó a tiempo y en perfecto estado, a pesar del pésimo estado de las carreteras.',
        26
    );
...
VALUES (
        ...
        NULL,
        'Pendiente',
        'El transportista ha llamado a Eva María para indicarle que el pedido llegará más tarde de lo esperado.',
        26
    );
...
VALUES (
        ...
        '2009-01-11',
        'Entregado',
        'Retrasado 1 dia por problemas de transporte',
        14
    );
...
VALUES (
        ...
        NULL,
        'Rechazado',
        'El cliente a anulado el pedido el dia 2009-01-10',
        13
    );
...
VALUES (
        ...
        NULL,
        'Rechazado',
        'El pedido no llego el dia que queria el cliente por fallo del transporte',
        15
    );
...
VALUES (
        ...
        NULL,
        'Pendiente',
        'El pedido no pudo ser entregado por problemas meteorologicos',
        15
    );
...
VALUES (
        ...
        '2008-12-17',
        'Entregado',
        'Fue entregado, pero faltaba mercancia que sera entregada otro dia',
        15
    );
...
VALUES (
        ...
        NULL,
        'Rechazado',
        'Los producto estaban en mal estado',
        28
    );
...
VALUES (
        ...
        '2009-01-29',
        'Entregado',
        'El pedido llego un poco mas tarde de la hora fijada',
        28
    );
...
VALUES (
        ...
        '2007-12-10',
        'Entregado',
        'La entrega se realizo dias antes de la fecha esperada por lo que el cliente quedo satisfecho',
        35
    );
...
VALUES (
        ...
        NULL,
        'Pendiente',
        'Debido a la nevada caída en la sierra, el pedido no podrá llegar hasta el día ',
        27
    );
...
VALUES (
        ...
        '2009-03-27',
        'Entregado',
        'Todo se entregó a su debido tiempo, incluso con un día de antelación',
        27
    );
...
VALUES (
        ...
        '2009-05-03',
        'Entregado',
        'El pedido se entregó tarde debido a la festividad celebrada en España durante esas fechas',
        27
    );
...
VALUES (
        ...
        '2009-05-17',
        'Entregado',
        'El pedido se entregó antes de lo esperado.',
        27
    );
...
VALUES (
        ...
        NULL,
        'Rechazado',
        'El pedido fue rechazado por el cliente',
        16
    );
...
VALUES (
        ...
        NULL,
        'Rechazado',
        'el producto ha sido rechazado por la pesima calidad',
        30
    );
...
VALUES (
        ...
        '2009-01-09',
        'Rechazado',
        'El producto ha sido rechazado por la tardanza de el envio',
        36
    );
...
VALUES (
        ...
        '2009-01-31',
        'Entregado',
        'El envio llego dos dias más tarde debido al mal tiempo',
        36
    );
...
VALUES (
        ...
        NULL,
        'Rechazado',
        'El pedido ha sido rechazado por la acumulacion de pago pendientes del cliente',
        32
    );
...
VALUES (
        ...
        '2008-12-29',
        'Rechazado',
        'El pedido ha sido rechazado por el cliente por el retraso en la entrega',
        36
    );
...
VALUES (
        ...
        '35-45',
        'Viveros EL OASIS',
        'Limpitatubos. arbolito de 6-7 m de altura. Ramas flexibles y colgantes (de ahí lo de \"llorón\")..',
        100,
        5,
        4
    );
